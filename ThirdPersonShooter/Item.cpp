...
void AItem::OnSphereOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	if (OtherActor)
	{
		AThirdPersonShooterCharacter* ThirdPersonShooterCharacter = Cast<AThirdPersonShooterCharacter>(OtherActor);
		if (ThirdPersonShooterCharacter)
		{
			ThirdPersonShooterCharacter->IncrementOverlappedItemCount(1);
		}
	}
}
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	if (Character && ItemZCurve)
	{
		...
		// Get location in fron of the camera
...
FVector AItem::GetInterpLocation()
{
	...
	case EItemType::EIT_Weapon:
		Character->GetInterpLocation(0).SceneComponent->GetComponentLocation();
		break;
	}
...
void AItem::StartItemCurve(AThirdPersonShooterCharacter* Char)
{
	...
	// This was added in 141! check to make sure (From ThirdPersonShooterCharacter.cpp)
	/*if (PickupSound)
	{
